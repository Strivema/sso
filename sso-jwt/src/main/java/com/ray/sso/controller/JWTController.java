...
import com.ray.sso.commons.JWTResponseData;
import com.ray.sso.commons.JWTResult;
import com.ray.sso.commons.JWTSubject;
import com.ray.sso.commons.JWTUsers;
import com.ray.sso.commons.JWTUtils;
...
public class JWTController {
	...
	public Object login(String username, String password){
		...
		if(JWTUsers.isLogin(username, password)){
			...
			String jwtToken = JWTUtils.createJWT(UUID.randomUUID().toString(), "ray-test-jwt",
